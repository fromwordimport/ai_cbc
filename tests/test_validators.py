...
class TestSchemaValidator:
    ...
    def test_valid_persona_passes(self, schema_validator: SchemaValidator, valid_persona: PersonaProfile) -> None:
        """A fully valid persona should pass schema validation."""
        result = schema_validator.validate(valid_persona)
        assert result.passed is True
        assert result.errors == []

    def test_missing_persona_id(self, schema_validator: SchemaValidator, valid_persona: PersonaProfile) -> None:
    ...
    def test_missing_segment(self, schema_validator: SchemaValidator, valid_persona: PersonaProfile) -> None:
    ...
    def test_invalid_gender(self, schema_validator: SchemaValidator, valid_persona: PersonaProfile) -> None:
    ...
    def test_invalid_city(self, schema_validator: SchemaValidator, valid_persona: PersonaProfile) -> None:
    ...
    def test_language_samples_wrong_count(self, schema_validator: SchemaValidator, valid_persona: PersonaProfile) -> None:
    ...
    def test_core_values_empty(self, schema_validator: SchemaValidator, valid_persona: PersonaProfile) -> None:
    ...
    def test_authenticity_score_out_of_range(self, schema_validator: SchemaValidator, valid_persona: PersonaProfile) -> None:
    ...
    def test_narrative_too_short(self, schema_validator: SchemaValidator, valid_persona: PersonaProfile) -> None:
    ...
    def test_missing_layer1_field(self, schema_validator: SchemaValidator, valid_persona: PersonaProfile) -> None:
    ...
    def test_missing_layer4_field(self, schema_validator: SchemaValidator, valid_persona: PersonaProfile) -> None:
...
class TestLogicValidator:
    ...
    def test_rule_002_tier1_low_income(self, logic_validator: LogicValidator, valid_persona: PersonaProfile) -> None:
    ...
    def test_rule_002_valid_combination(self, logic_validator: LogicValidator, valid_persona: PersonaProfile) -> None:
    ...
    def test_rule_003_student_high_income(self, logic_validator: LogicValidator, valid_persona: PersonaProfile) -> None:
    ...
    def test_rule_003_retiree_high_income(self, logic_validator: LogicValidator, valid_persona: PersonaProfile) -> None:
    ...
    def test_rule_003_normal_combination(self, logic_validator: LogicValidator, valid_persona: PersonaProfile) -> None:
    ...
    def test_rule_004_frugality_impulse(self, logic_validator: LogicValidator, valid_persona: PersonaProfile) -> None:
    ...
    def test_rule_004_high_sensitivity_luxury(self, logic_validator: LogicValidator, valid_persona: PersonaProfile) -> None:
    ...
    def test_rule_004_consistent(self, logic_validator: LogicValidator, valid_persona: PersonaProfile) -> None:
    ...
    def test_rule_005_sample_too_short(self, logic_validator: LogicValidator, valid_persona: PersonaProfile) -> None:
    ...
    def test_rule_005_sample_too_long(self, logic_validator: LogicValidator, valid_persona: PersonaProfile) -> None:
    ...
    def test_rule_006_forbidden_term(self, logic_validator: LogicValidator, valid_persona: PersonaProfile) -> None:
    ...
    def test_rule_006_forbidden_suanfa(self, logic_validator: LogicValidator, valid_persona: PersonaProfile) -> None:
    ...
    def test_multiple_rule_failures(self, logic_validator: LogicValidator, valid_persona: PersonaProfile) -> None:
