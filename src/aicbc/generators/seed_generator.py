...
CITY_TIER_INCOME_MULTIPLIERS: dict[str, list[float]] = {
    ...
    "三线城市": [0.04, 0.08, 0.20, 0.28, 0.22, 0.12, 0.05, 0.01],
    "四线城市": [0.05, 0.12, 0.25, 0.28, 0.18, 0.08, 0.03, 0.01],
    "五线城市": [0.06, 0.14, 0.28, 0.27, 0.16, 0.06, 0.02, 0.01],
    "县城/乡镇": [0.08, 0.18, 0.30, 0.25, 0.12, 0.05, 0.02, 0.00],
    "农村": [0.12, 0.25, 0.32, 0.20, 0.08, 0.03, 0.00, 0.00],
    "海外": [0.01, 0.02, 0.05, 0.12, 0.25, 0.30, 0.18, 0.07],
}
...
class SeedGenerator:
    ...
    def _sample_extra_tags(self, life_stage: str, income_bracket: str) -> dict[str, Any]:
